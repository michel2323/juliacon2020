...
\usepackage{xcolor}
\definecolor{OliveGreen}{RGB}{66, 91, 32}
...
\title[]{
    Toward Optimal Power Flow on Highly Parallel Vector Architectures\\
{\small INFORMS 2020, Optimization on Distributed Architectures
}
}
\author[]{Michel Schanen*, Daniel Adrian Maldonado, François Pacaud, Mihai Anitescu}
\subtitle{}
